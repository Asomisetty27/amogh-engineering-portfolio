      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            >
              {['Reasoning', 'Memory', 'Telemetry', 'Integrations'].map((tab) => (
                <button
                  key={tab}
                  style={{
                    padding: '8px 12px',
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.color = COLORS.steel.bright;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = COLORS.steel.faint;
                    e.currentTarget.style.color = COLORS.steel.muted;
                  }}
                >
                  [{tab}]
                </button>
            ...
            >
              <div style={{ opacity: 0.5 }}>
                Tab content coming soon: Decision Tree rules · Thermal fingerprints · Community
                benchmarks · Integration hooks
              </div>
            </div>
          </div>
        </div>
