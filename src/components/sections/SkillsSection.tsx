...
const skillCategories: { id: string; title: string; color: string; skills: SkillEntry[] }[] = [
  ...
  },
  {
    ...
    color: "neon-green",
    skills: [
      { name: "Python (systems & data)", evidence: "runtheta OSS package, pip install runtheta, v0.1.12 on PyPI + Helm chart" },
...
export default function SkillsSection() {
  ...
  const [expandedCategory, setExpandedCategory] = useState<string | null>("analog");
