  ...
  // ===== DOMAIN: AI & GPU SYSTEMS =====
  {
    ...
    module: {
      ...
      subsystems: [
        {
          id: "rtheta-core",
          title: "R_θ core + virtual ambient",
          description:
        ...
        {
          id: "peer-detection",
          title: "Peer-relative fleet anomaly detection",
          description:
        ...
        {
          id: "leadtime-survival",
          title: "Survival-analysis lead-time model",
          description:
      ...
      ownershipDisclosure: {
        owned: [
          ...
          "Kubernetes deployment design: Helm chart, DaemonSet hardening, and the Go node-labeler controller",
        ],
        aiAssisted: [
    ...
    diagrams: [],
    evidence: [
      { id: "theta-site", fileName: "runtheta.com", type: "link", description: "Theta's product site: what it does, the Princeton validation story, install paths (pip + Helm)", url: "https://runtheta.com" },
      { id: "theta-pypi", fileName: "runtheta on PyPI", type: "link", description: "Live PyPI package, v0.1.12", url: "https://pypi.org/project/runtheta/" },
